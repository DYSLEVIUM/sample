...
export class LeaveRequest extends Message<LeaveRequest> {
  ...
  /**
   * @generated from field: ecprt.LeaveRequest.Action action = 3;
   */
  action = LeaveRequest_Action.DISCONNECT;

  /**
   * @generated from field: ecprt.RegionSettings regions = 4;
   */
 ...
 *
 * @generated from enum ecprt.LeaveRequest.Action
 */
...
proto3.util.setEnumType(LeaveRequest_Action, "ecprt.LeaveRequest.Action", [
