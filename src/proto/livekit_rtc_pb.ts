...
// @generated from file livekit_rtc.proto (package ecprt, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum ecprt.SignalTarget
 */
...
proto3.util.setEnumType(SignalTarget, "ecprt.SignalTarget", [
  { no: 0, name: "PUBLISHER" },
  { no: 1, name: "SUBSCRIBER" },
]);

/**
 * @generated from enum ecprt.StreamState
 */
...
proto3.util.setEnumType(StreamState, "ecprt.StreamState", [
  { no: 0, name: "ACTIVE" },
  { no: 1, name: "PAUSED" },
]);

/**
 * @generated from enum ecprt.CandidateProtocol
 */
...
proto3.util.setEnumType(CandidateProtocol, "ecprt.CandidateProtocol", [
  { no: 0, name: "UDP" },
  { no: 1, name: "TCP" },
  { no: 2, name: "TLS" },
]);
...
export class SignalRequest extends Message<SignalRequest> {
  /**
   * @generated from oneof ecprt.SignalRequest.message
   */
  message: {
    /**
     * initial join exchange, for publisher
     *
     * @generated from field: ecprt.SessionDescription offer = 1;
     */
     ...
     *
     * @generated from field: ecprt.SessionDescription answer = 2;
     */
    value: SessionDescription;
    case: "answer";
  } | {
    /**
     * @generated from field: ecprt.TrickleRequest trickle = 3;
     */
    value: TrickleRequest;
    case: "trickle";
  } | {
    /**
     * @generated from field: ecprt.AddTrackRequest add_track = 4;
     */
     ...
     *
     * @generated from field: ecprt.MuteTrackRequest mute = 5;
     */
     ...
     *
     * @generated from field: ecprt.UpdateSubscription subscription = 6;
     */
     ...
     *
     * @generated from field: ecprt.UpdateTrackSettings track_setting = 7;
     */
     ...
     *
     * @generated from field: ecprt.LeaveRequest leave = 8;
     */
    value: LeaveRequest;
    case: "leave";
  } | {
     ...
     *
     * @generated from field: ecprt.UpdateVideoLayers update_layers = 10;
     */
     ...
     *
     * @generated from field: ecprt.SubscriptionPermission subscription_permission = 11;
     */
     ...
     *
     * @generated from field: ecprt.SyncState sync_state = 12;
     */
    value: SyncState;
    case: "syncState";
  } | {
     ...
     *
     * @generated from field: ecprt.SimulateScenario simulate = 13;
     */
     ...
     *
     * @generated from field: ecprt.UpdateParticipantMetadata update_metadata = 15;
     */
    value: UpdateParticipantMetadata;
    case: "updateMetadata";
  } | {
    /**
     * @generated from field: ecprt.Ping ping_req = 16;
     */
    value: Ping;
    case: "pingReq";
  ...
  static readonly typeName = "ecprt.SignalRequest";
...
/**
 * @generated from message ecprt.SignalResponse
 */
export class SignalResponse extends Message<SignalResponse> {
  /**
   * @generated from oneof ecprt.SignalResponse.message
   */
  message: {
    /**
     * sent when join is accepted
     *
     * @generated from field: ecprt.JoinResponse join = 1;
     */
    value: JoinResponse;
    case: "join";
  } | {
     ...
     *
     * @generated from field: ecprt.SessionDescription offer = 3;
     */
    value: SessionDescription;
    case: "offer";
  } | {
     ...
     *
     * @generated from field: ecprt.TrickleRequest trickle = 4;
     */
    value: TrickleRequest;
    case: "trickle";
  } | {
     ...
     *
     * @generated from field: ecprt.ParticipantUpdate update = 5;
     */
     ...
     *
     * @generated from field: ecprt.TrackPublishedResponse track_published = 6;
     */
     ...
     *
     * @generated from field: ecprt.MuteTrackRequest mute = 9;
     */
    value: MuteTrackRequest;
    case: "mute";
  } | {
     ...
     *
     * @generated from field: ecprt.RoomUpdate room_update = 11;
     */
    value: RoomUpdate;
    case: "roomUpdate";
  } | {
     ...
     *
     * @generated from field: ecprt.ConnectionQualityUpdate connection_quality = 12;
     */
     ...
     *
     * @generated from field: ecprt.SubscriptionPermissionUpdate subscription_permission_update = 15;
     */
     ...
     *
     * @generated from field: ecprt.TrackUnpublishedResponse track_unpublished = 17;
     */
     ...
     *
     * @generated from field: ecprt.ReconnectResponse reconnect = 19;
     */
     ...
     * respond to Ping
     *
     * @generated from field: ecprt.Pong pong_resp = 20;
     */
    value: Pong;
    case: "pongResp";
  } | {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.SignalResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.SimulcastCodec
 */
export class SimulcastCodec extends Message<SimulcastCodec> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.SimulcastCodec";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.AddTrackRequest
 */
export class AddTrackRequest extends Message<AddTrackRequest> {
  ...
  /**
   * @generated from field: ecprt.TrackType type = 3;
   */
  ...
  /**
   * @generated from field: ecprt.TrackSource source = 8;
   */
  source = TrackSource.UNKNOWN;

  /**
   * @generated from field: repeated ecprt.VideoLayer layers = 9;
   */
  layers: VideoLayer[] = [];

  /**
   * @generated from field: repeated ecprt.SimulcastCodec simulcast_codecs = 10;
   */
  ...
  /**
   * @generated from field: ecprt.Encryption.Type encryption = 14;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.AddTrackRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.TrickleRequest
 */
export class TrickleRequest extends Message<TrickleRequest> {
  ...
  /**
   * @generated from field: ecprt.SignalTarget target = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.TrickleRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.MuteTrackRequest
 */
export class MuteTrackRequest extends Message<MuteTrackRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.MuteTrackRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.JoinResponse
 */
export class JoinResponse extends Message<JoinResponse> {
  /**
   * @generated from field: ecprt.Room room = 1;
   */
  room?: Room;

  /**
   * @generated from field: ecprt.ParticipantInfo participant = 2;
   */
  participant?: ParticipantInfo;

  /**
   * @generated from field: repeated ecprt.ParticipantInfo other_participants = 3;
   */
  ...
  /**
   * @generated from field: repeated ecprt.ICEServer ice_servers = 5;
   */
  ...
  /**
   * @generated from field: ecprt.ClientConfiguration client_configuration = 8;
   */
  ...
  /**
   * @generated from field: ecprt.ServerInfo server_info = 12;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.JoinResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.ReconnectResponse
 */
export class ReconnectResponse extends Message<ReconnectResponse> {
  /**
   * @generated from field: repeated ecprt.ICEServer ice_servers = 1;
   */
  iceServers: ICEServer[] = [];

  /**
   * @generated from field: ecprt.ClientConfiguration client_configuration = 2;
   */
  clientConfiguration?: ClientConfiguration;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.ReconnectResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.TrackPublishedResponse
 */
export class TrackPublishedResponse extends Message<TrackPublishedResponse> {
  ...
  /**
   * @generated from field: ecprt.TrackInfo track = 2;
   */
  track?: TrackInfo;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.TrackPublishedResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "cid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message ecprt.TrackUnpublishedResponse
 */
export class TrackUnpublishedResponse extends Message<TrackUnpublishedResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.TrackUnpublishedResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.SessionDescription
 */
export class SessionDescription extends Message<SessionDescription> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.SessionDescription";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.ParticipantUpdate
 */
export class ParticipantUpdate extends Message<ParticipantUpdate> {
  /**
   * @generated from field: repeated ecprt.ParticipantInfo participants = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.ParticipantUpdate";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.UpdateSubscription
 */
export class UpdateSubscription extends Message<UpdateSubscription> {
  ...
  /**
   * @generated from field: repeated ecprt.ParticipantTracks participant_tracks = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.UpdateSubscription";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.UpdateTrackSettings
 */
export class UpdateTrackSettings extends Message<UpdateTrackSettings> {
   ...
   *
   * @generated from field: ecprt.VideoQuality quality = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.UpdateTrackSettings";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "track_sids", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
...
/**
 * @generated from message ecprt.LeaveRequest
 */
export class LeaveRequest extends Message<LeaveRequest> {
  ...
  /**
   * @generated from field: ecprt.DisconnectReason reason = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.LeaveRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message ecprt.UpdateVideoLayers
 */
export class UpdateVideoLayers extends Message<UpdateVideoLayers> {
  ...
  /**
   * @generated from field: repeated ecprt.VideoLayer layers = 2;
   */
  layers: VideoLayer[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.UpdateVideoLayers";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "track_sid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message ecprt.UpdateParticipantMetadata
 */
export class UpdateParticipantMetadata extends Message<UpdateParticipantMetadata> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.UpdateParticipantMetadata";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.ICEServer
 */
export class ICEServer extends Message<ICEServer> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.ICEServer";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.SpeakersChanged
 */
export class SpeakersChanged extends Message<SpeakersChanged> {
  /**
   * @generated from field: repeated ecprt.SpeakerInfo speakers = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.SpeakersChanged";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.RoomUpdate
 */
export class RoomUpdate extends Message<RoomUpdate> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.RoomUpdate";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room", kind: "message", T: Room },
  ]);
...
/**
 * @generated from message ecprt.ConnectionQualityInfo
 */
export class ConnectionQualityInfo extends Message<ConnectionQualityInfo> {
  ...
  /**
   * @generated from field: ecprt.ConnectionQuality quality = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.ConnectionQualityInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.ConnectionQualityUpdate
 */
export class ConnectionQualityUpdate extends Message<ConnectionQualityUpdate> {
  /**
   * @generated from field: repeated ecprt.ConnectionQualityInfo updates = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.ConnectionQualityUpdate";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.StreamStateInfo
 */
export class StreamStateInfo extends Message<StreamStateInfo> {
  ...
  /**
   * @generated from field: ecprt.StreamState state = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.StreamStateInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "participant_sid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message ecprt.StreamStateUpdate
 */
export class StreamStateUpdate extends Message<StreamStateUpdate> {
  /**
   * @generated from field: repeated ecprt.StreamStateInfo stream_states = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.StreamStateUpdate";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.SubscribedQuality
 */
export class SubscribedQuality extends Message<SubscribedQuality> {
  /**
   * @generated from field: ecprt.VideoQuality quality = 1;
   */
  quality = VideoQuality.LOW;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.SubscribedQuality";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.SubscribedCodec
 */
export class SubscribedCodec extends Message<SubscribedCodec> {
  ...
  /**
   * @generated from field: repeated ecprt.SubscribedQuality qualities = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.SubscribedCodec";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "codec", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message ecprt.SubscribedQualityUpdate
 */
export class SubscribedQualityUpdate extends Message<SubscribedQualityUpdate> {
  ...
  /**
   * @generated from field: repeated ecprt.SubscribedQuality subscribed_qualities = 2;
   */
  subscribedQualities: SubscribedQuality[] = [];

  /**
   * @generated from field: repeated ecprt.SubscribedCodec subscribed_codecs = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.SubscribedQualityUpdate";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "track_sid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message ecprt.TrackPermission
 */
export class TrackPermission extends Message<TrackPermission> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.TrackPermission";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "participant_sid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message ecprt.SubscriptionPermission
 */
export class SubscriptionPermission extends Message<SubscriptionPermission> {
  ...
  /**
   * @generated from field: repeated ecprt.TrackPermission track_permissions = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.SubscriptionPermission";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.SubscriptionPermissionUpdate
 */
export class SubscriptionPermissionUpdate extends Message<SubscriptionPermissionUpdate> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.SubscriptionPermissionUpdate";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "participant_sid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "track_sid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message ecprt.SyncState
 */
export class SyncState extends Message<SyncState> {
  /**
   * last subscribe answer before reconnecting
   *
   * @generated from field: ecprt.SessionDescription answer = 1;
   */
  answer?: SessionDescription;

  /**
   * @generated from field: ecprt.UpdateSubscription subscription = 2;
   */
  subscription?: UpdateSubscription;

  /**
   * @generated from field: repeated ecprt.TrackPublishedResponse publish_tracks = 3;
   */
  publishTracks: TrackPublishedResponse[] = [];

  /**
   * @generated from field: repeated ecprt.DataChannelInfo data_channels = 4;
   */
   ...
   *
   * @generated from field: ecprt.SessionDescription offer = 5;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.SyncState";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.DataChannelInfo
 */
export class DataChannelInfo extends Message<DataChannelInfo> {
  ...
  /**
   * @generated from field: ecprt.SignalTarget target = 3;
   */
  target = SignalTarget.PUBLISHER;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.DataChannelInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.SimulateScenario
 */
export class SimulateScenario extends Message<SimulateScenario> {
  /**
   * @generated from oneof ecprt.SimulateScenario.scenario
   */
  scenario: {
    /**
     ...
     *
     * @generated from field: ecprt.CandidateProtocol switch_candidate_protocol = 5;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.SimulateScenario";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.Ping
 */
export class Ping extends Message<Ping> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.Ping";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.Pong
 */
export class Pong extends Message<Pong> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.Pong";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.RegionSettings
 */
export class RegionSettings extends Message<RegionSettings> {
  /**
   * @generated from field: repeated ecprt.RegionInfo regions = 1;
   */
  regions: RegionInfo[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.RegionSettings";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.RegionInfo
 */
export class RegionInfo extends Message<RegionInfo> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.RegionInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.SubscriptionResponse
 */
export class SubscriptionResponse extends Message<SubscriptionResponse> {
  ...
  /**
   * @generated from field: ecprt.SubscriptionError err = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.SubscriptionResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "track_sid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message ecprt.DeviceInfo
 */
export class DeviceInfo extends Message<DeviceInfo> {
  /**
   * @generated from field: ecprt.DeviceInfo.SDK sdk = 1;
   */
  sdk = DeviceInfo_SDK.UNKNOWN;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.DeviceInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum ecprt.DeviceInfo.SDK
 */
export enum DeviceInfo_SDK {
  /**
...
proto3.util.setEnumType(DeviceInfo_SDK, "ecprt.DeviceInfo.SDK", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "JS" },
  { no: 2, name: "SWIFT" },
  { no: 3, name: "ANDROID" },
