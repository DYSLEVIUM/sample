...
// @generated from file livekit_models.proto (package ecprt, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum ecprt.AudioCodec
 */
...
proto3.util.setEnumType(AudioCodec, "ecprt.AudioCodec", [
...
/**
 * @generated from enum ecprt.VideoCodec
 */
...
proto3.util.setEnumType(VideoCodec, "ecprt.VideoCodec", [
...
/**
 * @generated from enum ecprt.ImageCodec
 */
...
proto3.util.setEnumType(ImageCodec, "ecprt.ImageCodec", [
  { no: 0, name: "IC_DEFAULT" },
  { no: 1, name: "IC_JPEG" },
]);

/**
 * @generated from enum ecprt.TrackType
 */
...
proto3.util.setEnumType(TrackType, "ecprt.TrackType", [
  { no: 0, name: "AUDIO" },
  { no: 1, name: "VIDEO" },
  { no: 2, name: "DATA" },
]);
...
/**
 * @generated from enum ecprt.TrackSource
 */
...
proto3.util.setEnumType(TrackSource, "ecprt.TrackSource", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "CAMERA" },
...
/**
 * @generated from enum ecprt.VideoQuality
 */
...
proto3.util.setEnumType(VideoQuality, "ecprt.VideoQuality", [
  { no: 0, name: "LOW" },
  { no: 1, name: "MEDIUM" },
  { no: 2, name: "HIGH" },
  { no: 3, name: "OFF" },
...
/**
 * @generated from enum ecprt.ConnectionQuality
 */
...
proto3.util.setEnumType(ConnectionQuality, "ecprt.ConnectionQuality", [
  { no: 0, name: "POOR" },
  { no: 1, name: "GOOD" },
  { no: 2, name: "EXCELLENT" },
  { no: 3, name: "LOST" },
...
/**
 * @generated from enum ecprt.ClientConfigSetting
 */
...
proto3.util.setEnumType(ClientConfigSetting, "ecprt.ClientConfigSetting", [
  { no: 0, name: "UNSET" },
  { no: 1, name: "DISABLED" },
  { no: 2, name: "ENABLED" },
]);
...
/**
 * @generated from enum ecprt.DisconnectReason
 */
...
proto3.util.setEnumType(DisconnectReason, "ecprt.DisconnectReason", [
...
/**
 * @generated from enum ecprt.ReconnectReason
 */
...
proto3.util.setEnumType(ReconnectReason, "ecprt.ReconnectReason", [
...
/**
 * @generated from enum ecprt.SubscriptionError
 */
...
proto3.util.setEnumType(SubscriptionError, "ecprt.SubscriptionError", [
...
/**
 * @generated from message ecprt.Room
 */
export class Room extends Message<Room> {
  ...
  /**
   * @generated from field: repeated ecprt.Codec enabled_codecs = 7;
   */
  enabledCodecs: Codec[] = [];
  ...
  /**
   * @generated from field: ecprt.TimedVersion version = 13;
   */
  ...
  static readonly typeName = "ecprt.Room";
...
/**
 * @generated from message ecprt.Codec
 */
export class Codec extends Message<Codec> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.Codec";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.PlayoutDelay
 */
export class PlayoutDelay extends Message<PlayoutDelay> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.PlayoutDelay";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.ParticipantPermission
 */
export class ParticipantPermission extends Message<ParticipantPermission> {
   ...
   *
   * @generated from field: repeated ecprt.TrackSource can_publish_sources = 9;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.ParticipantPermission";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.ParticipantInfo
 */
export class ParticipantInfo extends Message<ParticipantInfo> {
  ...
  /**
   * @generated from field: ecprt.ParticipantInfo.State state = 3;
   */
  state = ParticipantInfo_State.JOINING;

  /**
   * @generated from field: repeated ecprt.TrackInfo tracks = 4;
   */
  tracks: TrackInfo[] = [];
  ...
  /**
   * @generated from field: ecprt.ParticipantPermission permission = 11;
   */
  ...
  /**
   * @generated from field: ecprt.ParticipantInfo.Kind kind = 14;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.ParticipantInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from enum ecprt.ParticipantInfo.State
 */
...
proto3.util.setEnumType(ParticipantInfo_State, "ecprt.ParticipantInfo.State", [
  { no: 0, name: "JOINING" },
  { no: 1, name: "JOINED" },
  { no: 2, name: "ACTIVE" },
...
/**
 * @generated from enum ecprt.ParticipantInfo.Kind
 */
...
proto3.util.setEnumType(ParticipantInfo_Kind, "ecprt.ParticipantInfo.Kind", [
  { no: 0, name: "STANDARD" },
  { no: 1, name: "INGRESS" },
  { no: 2, name: "EGRESS" },
  { no: 3, name: "SIP" },
...
/**
 * @generated from message ecprt.Encryption
 */
export class Encryption extends Message<Encryption> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.Encryption";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from enum ecprt.Encryption.Type
 */
...
proto3.util.setEnumType(Encryption_Type, "ecprt.Encryption.Type", [
  { no: 0, name: "NONE" },
  { no: 1, name: "GCM" },
  { no: 2, name: "CUSTOM" },
]);
...
/**
 * @generated from message ecprt.SimulcastCodecInfo
 */
export class SimulcastCodecInfo extends Message<SimulcastCodecInfo> {
  ...
  /**
   * @generated from field: repeated ecprt.VideoLayer layers = 4;
   */
  layers: VideoLayer[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.SimulcastCodecInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.TrackInfo
 */
export class TrackInfo extends Message<TrackInfo> {
  ...
  /**
   * @generated from field: ecprt.TrackType type = 2;
   */
   ...
   * source of media
   *
   * @generated from field: ecprt.TrackSource source = 9;
   */
  source = TrackSource.UNKNOWN;

  /**
   * @generated from field: repeated ecprt.VideoLayer layers = 10;
   */
  layers: VideoLayer[] = [];
  ...
  /**
   * @generated from field: repeated ecprt.SimulcastCodecInfo codecs = 13;
   */
  ...
  /**
   * @generated from field: ecprt.Encryption.Type encryption = 16;
   */
  ...
  /**
   * @generated from field: ecprt.TimedVersion version = 18;
   */
  version?: TimedVersion;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.TrackInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message ecprt.VideoLayer
 */
export class VideoLayer extends Message<VideoLayer> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.VideoLayer";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * new DataPacket API
 *
 * @generated from message ecprt.DataPacket
 */
export class DataPacket extends Message<DataPacket> {
  /**
   * @generated from field: ecprt.DataPacket.Kind kind = 1;
   */
  kind = DataPacket_Kind.RELIABLE;

  /**
   * @generated from oneof ecprt.DataPacket.value
   */
  value: {
    /**
     * @generated from field: ecprt.UserPacket user = 2;
     */
    value: UserPacket;
    case: "user";
  } | {
    /**
     * @generated from field: ecprt.ActiveSpeakerUpdate speaker = 3;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.DataPacket";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum ecprt.DataPacket.Kind
 */
...
proto3.util.setEnumType(DataPacket_Kind, "ecprt.DataPacket.Kind", [
  { no: 0, name: "RELIABLE" },
  { no: 1, name: "LOSSY" },
]);

/**
 * @generated from message ecprt.ActiveSpeakerUpdate
 */
export class ActiveSpeakerUpdate extends Message<ActiveSpeakerUpdate> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.ActiveSpeakerUpdate";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.SpeakerInfo
 */
export class SpeakerInfo extends Message<SpeakerInfo> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.SpeakerInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message ecprt.UserPacket
 */
export class UserPacket extends Message<UserPacket> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.UserPacket";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.ParticipantTracks
 */
export class ParticipantTracks extends Message<ParticipantTracks> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.ParticipantTracks";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "participant_sid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message ecprt.ServerInfo
 */
export class ServerInfo extends Message<ServerInfo> {
  /**
   * @generated from field: ecprt.ServerInfo.Edition edition = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.ServerInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum ecprt.ServerInfo.Edition
 */
...
proto3.util.setEnumType(ServerInfo_Edition, "ecprt.ServerInfo.Edition", [
  { no: 0, name: "Standard" },
  { no: 1, name: "Cloud" },
]);
 ...
 *
 * @generated from message ecprt.ClientInfo
 */
export class ClientInfo extends Message<ClientInfo> {
  /**
   * @generated from field: ecprt.ClientInfo.SDK sdk = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.ClientInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum ecprt.ClientInfo.SDK
 */
...
proto3.util.setEnumType(ClientInfo_SDK, "ecprt.ClientInfo.SDK", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "JS" },
  { no: 2, name: "SWIFT" },
  { no: 3, name: "ANDROID" },
 ...
 *
 * @generated from message ecprt.ClientConfiguration
 */
export class ClientConfiguration extends Message<ClientConfiguration> {
  /**
   * @generated from field: ecprt.VideoConfiguration video = 1;
   */
  video?: VideoConfiguration;

  /**
   * @generated from field: ecprt.VideoConfiguration screen = 2;
   */
  screen?: VideoConfiguration;

  /**
   * @generated from field: ecprt.ClientConfigSetting resume_connection = 3;
   */
  resumeConnection = ClientConfigSetting.UNSET;

  /**
   * @generated from field: ecprt.DisabledCodecs disabled_codecs = 4;
   */
  disabledCodecs?: DisabledCodecs;

  /**
   * @generated from field: ecprt.ClientConfigSetting force_relay = 5;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.ClientConfiguration";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.VideoConfiguration
 */
export class VideoConfiguration extends Message<VideoConfiguration> {
  /**
   * @generated from field: ecprt.ClientConfigSetting hardware_encoder = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.VideoConfiguration";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.DisabledCodecs
 */
export class DisabledCodecs extends Message<DisabledCodecs> {
  /**
   * disabled for both publish and subscribe
   *
   * @generated from field: repeated ecprt.Codec codecs = 1;
   */
  codecs: Codec[] = [];
   ...
   *
   * @generated from field: repeated ecprt.Codec publish = 2;
   */
  publish: Codec[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.DisabledCodecs";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.RTPDrift
 */
export class RTPDrift extends Message<RTPDrift> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.RTPDrift";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ecprt.RTPStats
 */
export class RTPStats extends Message<RTPStats> {
  ...
  /**
   * @generated from field: ecprt.RTPDrift packet_drift = 44;
   */
   ...
   * NEXT_ID: 46
   *
   * @generated from field: ecprt.RTPDrift report_drift = 45;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.RTPStats";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "start_time", kind: "message", T: Timestamp },
    { no: 2, name: "end_time", kind: "message", T: Timestamp },
    { no: 3, name: "duration", kind: "scalar", T: 1 /* ScalarType.DOUBLE */ },
...
/**
 * @generated from message ecprt.TimedVersion
 */
export class TimedVersion extends Message<TimedVersion> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ecprt.TimedVersion";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
